...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.linkedin.com/in/haotian-bai-17373318b/}{LinkedIn} & 微信号: bht717398\\
  \href{https://www.youtube.com/channel/UC14daG1SgXKoySI92mKLdiQ/}{YouTube频道}
 \\
\end{tabular*}
...
{身份贴合的虚拟形象陪伴体，搭载情感条件化、主动式的“有灵魂”对话基底 [\ref{AvatarMe}]；可调控陪伴智能体状态的连续情感向量 [\ref{RAR-CV}]}
\resumeItemListEnd
...
\section{创业}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItem{落地与影响}{已交付跨平台 Web 产品、云端后端与原生 iOS 应用\href{https://holosoul.cn/}{\textbf{灵伴AI}}（\href{https://apps.apple.com/us/app/id6777871257}{[App Store]}）；通过成对用户实地研究验证。荣获\textbf{日内瓦国际发明展铜奖}（2026），并在\textbf{广州科技创新暨港科大百万奖金创业大赛}中荣获\textbf{三等奖}并晋级决赛（详见\href{https://kjj.gz.gov.cn/gsxx/content/post_10524225.html}{官方公告}）。}
    \resumeItemListEnd
\resumeSubHeadingListEnd
...
\item \textbf{H. Bai} 等, "RAR-CV: Continuous Affect Vectors for Controllable Companion-Agent State." \textit{准备投稿}, AAAI, 2027. \textit{（面向陪伴智能体的可调控连续 K 锚点情感状态表征；第一作者。）} \label{RAR-CV}
\item \textbf{H. Bai} 等, "AvatarMe: Identity-Contingent Avatar Companions for Sustaining Social Connection." \textit{准备投稿}, CHI, 2027. \textit{（身份贴合的虚拟形象克隆 + 主动式、情感条件化的陪伴；第一作者，负责系统设计与两阶段用户研究。）} \label{AvatarMe}
